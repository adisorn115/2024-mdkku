...
success px-3 py-2"><i
                                    ...
                                    class="fa fa-plus"></i> เพิ่มสินคา้</a>
                        </div>
                    </div>
                </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex px-2 py-1">
                                        <div>
                                            <img src="{{$p->getImageUrl()}}" class="avatar avatar-sm me-3" alt="user1">
                                ...
                                <td class="align-middle">
                                    <form action="#" method="POST">
                                        ...
                                        <button type="submit" class="btn btn-outline-danger px-3 py-2"
                                                onclick="return confirm('คุณต้องการลบข้อมูลหรือไม่?')"><i class="fa fa-trash"></i> ลบ</button>
